...
class Elearning_test5(unittest.TestCase):
    ...
    def test_login(self):
        ...
        time.sleep(2)
        next_section = driver.find_element_by_xpath('/html/body/div/ul/li[1]/a').click()
        time.sleep(2)
        take_test = driver.find_element_by_xpath('/html/body/div/p[3]/a').click()
        time.sleep(2)
        try:
